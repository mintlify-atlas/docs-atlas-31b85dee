...
sidebarTitle: "Auth"
description: "ContabilidadISV uses JWT bearer tokens for authentication. Obtain a token via POST /api/auth/login and include it in the Authorization header on every subsequent request."
---
