...
description: "Manage business client records in ContabilidadISV. Each client has an RTN (Honduran tax ID), sector, representative, contact details, and an optional logo."
---
