---
title: "Files API — Excel Upload and Download Endpoints"
sidebarTitle: "Files"
description: "Upload Excel files (.xlsx/.xls, max 10 MB) to import consolidated accounting data, browse upload history, and download previously uploaded files by ID."
---
...
curl -X POST https://your-host/api/files/upload \
  ...
  -F "file=@/path/to/consolidacion_junio.xlsx"
```
