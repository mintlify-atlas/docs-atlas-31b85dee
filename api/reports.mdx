...
description: "Three reporting endpoints: consolidation count metrics, client activity rankings, and aggregated per-account Debe/Haber summaries with bimestral, trimestral, semestral, and annual period filters."
---
