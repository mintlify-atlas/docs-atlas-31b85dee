...
description: "ContabilidadISV streamlines ISV and IST tax consolidation for Honduran accountants — double-entry ledgers, automated tax formulas, client management, and Excel/PDF exports."
---
...
| Backend | Node.js, Express.js, express-validator, JWT (`jsonwebtoken`), `bcrypt` |
