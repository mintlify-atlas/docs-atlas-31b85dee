...
description: "ContabilidadISV architecture: React/TypeScript SPA, Express REST API, SQL Server, and optional Electron shell for offline Windows desktop deployment."
---
