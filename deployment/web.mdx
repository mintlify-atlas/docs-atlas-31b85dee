---
title: "Deploy ContabilidadISV as a Web App on Linux or Windows"
sidebarTitle: "Web Deployment"
description: "Build and deploy ContabilidadISV's React frontend and Express backend for production use on a local network or server with SQL Server."
---
